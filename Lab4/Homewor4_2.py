...
class NumberScramble:
    ...
    def heuristic(self):
        ...
        player_score = 0
        for triplet in self.triplets_sum_15:
            if all(num in self.available_numbers or num in self.player_moves['AI'] for num in triplet): #verificam daca un toate numerele din triplet fie nu au fost deja alese fie au fost alese de jucatorul resp.
                ai_score += 1
